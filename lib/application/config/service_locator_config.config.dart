...
import 'package:cuidapet_api/application/database/i_database_connection_impl.dart'
    as _i4;
import 'package:cuidapet_api/application/logger/i_logger.dart' as _i10;
...
import 'package:cuidapet_api/modules/user/controller/user_controller.dart'
    as _i14;
import 'package:cuidapet_api/modules/user/data/i_user_repository.dart' as _i8;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i6.ISupplierService>(() => _i7.ISupplierServiceImpl());
  gh.lazySingleton<_i8.IUserRepository>(() => _i9.IUserRepositoryImpl(
  ...
  gh.factory<_i13.SupplierController>(() => _i13.SupplierController());
  ...
  gh.lazySingleton<_i16.ICategoriesRepository>(
      () => _i17.ICategoriesRepositoryImpl(
            connection: gh<_i3.IDatabaseConnection>(),
            log: gh<_i10.ILogger>(),
          ));
  gh.lazySingleton<_i18.ICategoriesService>(() => _i19.ICategoriesServiceImpl(
      repository: gh<_i16.ICategoriesRepository>()));
  gh.factory<_i20.CategoriesController>(
      () => _i20.CategoriesController(service: gh<_i18.ICategoriesService>()));
  return getIt;
}
