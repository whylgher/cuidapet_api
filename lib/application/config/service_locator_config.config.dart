...
import 'package:cuidapet_api/application/database/i_database_connection_impl.dart'
    as _i9;
import 'package:cuidapet_api/application/logger/i_logger.dart' as _i13;
...
import 'package:cuidapet_api/modules/user/data/i_user_repository_impl.dart'
    as _i12;
import 'package:cuidapet_api/modules/user/service/i_user_service.dart' as _i14;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i4.ICategoriesRepository>(
      () => _i5.ICategoriesRepositoryImpl());
  gh.lazySingleton<_i6.ICategoriesService>(() => _i7.ICategoriesServiceImpl());
  gh.lazySingleton<_i8.IDatabaseConnection>(() =>
      _i9.IDatabaseConnectionImpl(gh<_i10.DatabaseConnectionConfiguration>()));
  gh.lazySingleton<_i11.IUserRepository>(() => _i12.IUserRepositoryImpl(
        connection: gh<_i8.IDatabaseConnection>(),
        log: gh<_i13.ILogger>(),
      ));
  gh.lazySingleton<_i14.IUserService>(() => _i15.IUserServiceImpl(
        userRepository: gh<_i11.IUserRepository>(),
        log: gh<_i13.ILogger>(),
      ));
  gh.factory<_i16.UserController>(() => _i16.UserController(
        userService: gh<_i14.IUserService>(),
        log: gh<_i13.ILogger>(),
      ));
